...
export default function Home() {
  ...
  useEffect(function () {
    async function fetchOfferListings() {
      try {
        const res = await fetch("/api/v1/listings?offer=true&limit=4");
    ...
    async function fetchRentListings() {
      try {
        const res = await fetch("/api/v1/listings?type=rent&limit=4");
        const data = await res.json();
    ...
    async function fetchSaleListings() {
      try {
        const res = await fetch("/api/v1/listings?type=sale&limit=4");
        const data = await res.json();
